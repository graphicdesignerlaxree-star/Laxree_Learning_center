...
const ROOFING_STUDY_CHAPTERS: StudyChapter[] = [
  ...
  },
  {
    ...
    content: [
      ...
      `SALES PITCH SUMMARY — When pitching stone-coated tiles, use this 3-step framework: (1) PROBLEM: "Your current Tata GSW sheet roof rusts in 5-8 years, makes rain noise like a tin drum, and turns your attic into an oven in summer." (2) SOLUTION: "Laxree stone-coated tiles add a stone-chip layer on AZ-coated steel — noise drops 90%, heat drops 70%, lifespan goes from 5 years to 25+ years." (3) VALUE: "A 1,500 sq ft roof costs ₹2.7 lakh installed — that's ₹13,333/year over 20 years, vs ₹20,000/year for re-sheeting with GSW every 6 years. You save money AND get a premium look." Close by showing the color samples and an installed-site photo. This pitch wins because it competes on total cost of ownership, not just upfront price.`,
    ],
  },
  {
    id: 'r-ch3',
  ...
  },
  {
    ...
    content: [
      ...
      `Dealers enjoy complete pricing flexibility with no strict MRP enforcement — unlike some other Laxree product lines. Margins are significant, sometimes exceeding 50%, and dealers can price above SSP or MRP to increase profitability on premium projects. Cash discounts are typically offered for large orders exceeding 3,000-4,000 tiles (valued at approximately ₹15 lakhs and above). Billing flexibility exists too: dealers can choose whether invoicing is done directly to them or passed on to the end customer, enabling reseller margin protection. This makes the roofing dealership one of the most attractive in the Laxree portfolio for ambitious resellers. PRACTICAL EXAMPLE — PRICING FLEXIBILITY IN ACTION: A stock dealer in Bangalore wins a 50-villa township project (each villa 2,000 sq ft = 400 tiles/villa = 20,000 tiles total). Dealer cost (DP) = ₹350/tile. Project value at MRP ₹440 = ₹88,00,000. Dealer offers builder ₹410/tile (below MRP, above SSP) = ₹82,00,000 quote. Dealer profit = ₹82,00,000 - (20,000 × ₹350) = ₹82,00,000 - ₹70,00,000 = ₹12,00,000. For this volume, dealer also gets ₹10/tile bulk discount from Laxree = ₹2,00,000 additional profit. Total dealer profit = ₹14,00,000 on a single project. This is why roofing dealers can earn ₹10-₹20 lakh/year with just 5-10 large projects.`,
